...
class IndexPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/IndexPage.ets(155:5)", "entry");
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/IndexPage.ets(156:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Web.debugLine("entry/src/main/ets/pages/IndexPage.ets(157:9)", "entry");
            Web.layoutWeight(1);
            Web.javaScriptProxy({
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/IndexPage.ets(198:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/IndexPage.ets(199:11)", "entry");
            Button.width({ "id": 16777219, "type": 10002, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Button.backgroundColor({ "id": 16777268, "type": 10001, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.webCanBack ? { "id": 16777244, "type": 20000, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" } : { "id": 16777240, "type": 20000, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/pages/IndexPage.ets(200:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithChild();
            Button.debugLine("entry/src/main/ets/pages/IndexPage.ets(217:11)", "entry");
            Button.width({ "id": 16777219, "type": 10002, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Button.backgroundColor({ "id": 16777268, "type": 10001, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Button.aspectRatio(1);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(this.webCanForward ? { "id": 16777242, "type": 20000, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" } : { "id": 16777261, "type": 20000, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/pages/IndexPage.ets(218:13)", "entry");
            Image.width({ "id": 16777227, "type": 10002, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Image.aspectRatio(1);
        }, Image);
        Button.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithChild();
            Button.debugLine("entry/src/main/ets/pages/IndexPage.ets(235:11)", "entry");
            Button.width({ "id": 16777219, "type": 10002, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Button.backgroundColor({ "id": 16777268, "type": 10001, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Button.aspectRatio(1);
            Button.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777274, "type": 20000, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/pages/IndexPage.ets(236:13)", "entry");
            Image.width({ "id": 16777227, "type": 10002, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
            Image.aspectRatio(1);
        }, Image);
        Button.pop();
            ...
            if (this.showCompareBtn) {
                this.ifElseBranchUpdateFunction(0, () => {
                        ...
                        if (this.compareMode) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Button.debugLine("entry/src/main/ets/pages/IndexPage.ets(265:11)", "entry");
                                    ...
                                    Button.backgroundColor({ "id": 16777269, "type": 10001, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/IndexPage.ets(293:9)", "entry");
                        Button.constraintSize({
                            minWidth: this.currentBreakpoint === BreakpointConstants.BREAKPOINT_LG ? 88 : 72,
                            maxWidth: this.currentBreakpoint === BreakpointConstants.BREAKPOINT_LG ? 88 : 72,
                            minHeight: this.currentBreakpoint === BreakpointConstants.BREAKPOINT_LG ? 88 : 72,
                        ...
                        Button.borderRadius(this.currentBreakpoint === BreakpointConstants.BREAKPOINT_LG ? 44 : 36);
                        Button.backgroundColor(this.compareMode ? '#E92F4F' : { "id": 16777269, "type": 10001, params: [], "bundleName": "com.example.pageredirection", "moduleName": "entry" });
                        Button.fontColor(Color.White);
                        Button.fontSize(this.currentBreakpoint === BreakpointConstants.BREAKPOINT_LG ? 22 : 18);
                        Button.fontWeight(FontWeight.Medium);
                        Button.shadow({
